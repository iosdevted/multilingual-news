//
//  JapaneseNewsViewController.swift
//  one-article
//
...
class JapaneseNewsViewController: UIViewController {
    ...
    private func dateFormat(date: String) -> String {
        ...
        if let date2 = formatter1.date(from: date) {
            ...
            formatter2.locale = Locale(identifier: "jp_JP")
...
extension JapaneseNewsViewController: UITableViewDelegate {
...
extension JapaneseNewsViewController: UITableViewDataSource {
